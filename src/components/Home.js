    ...
    <div className="home-container">
      ...
      <footer className="home-footer">
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul>
              ...
              <li><button type="button" onClick={() => window.location.hash = 'contact'} style={{ background: 'none', border: 'none', padding: 0, margin: 0, color: 'inherit', font: 'inherit', cursor: 'pointer' }}>Contact</button></li>
            </ul>
          </div>
          <div className="footer-section">
          ...
          <div className="footer-section">
            <h4>Support</h4>
            <ul>
              <li><button type="button" onClick={() => window.location.hash = 'help'} style={{ background: 'none', border: 'none', padding: 0, margin: 0, color: 'inherit', font: 'inherit', cursor: 'pointer' }}>Help Center</button></li>
              <li><button type="button" onClick={() => window.location.hash = 'adoption-guide'} style={{ background: 'none', border: 'none', padding: 0, margin: 0, color: 'inherit', font: 'inherit', cursor: 'pointer' }}>Adoption Guide</button></li>
              <li><button type="button" onClick={() => window.location.hash = 'care-tips'} style={{ background: 'none', border: 'none', padding: 0, margin: 0, color: 'inherit', font: 'inherit', cursor: 'pointer' }}>Pet Care Tips</button></li>
              <li><button type="button" onClick={() => window.location.hash = 'volunteer'} style={{ background: 'none', border: 'none', padding: 0, margin: 0, color: 'inherit', font: 'inherit', cursor: 'pointer' }}>Volunteer</button></li>
            </ul>
          </div>
          <div className="footer-section">
            <h4>Contact Us</h4>
        ...
        <div className="footer-bottom">
          <p>&copy; 2025 TailMate. All rights reserved. | <button type="button" onClick={() => window.location.hash = 'privacy'} style={{ background: 'none', border: 'none', padding: 0, margin: 0, color: 'inherit', font: 'inherit', cursor: 'pointer' }}>Privacy Policy</button> | <button type="button" onClick={() => window.location.hash = 'terms'} style={{ background: 'none', border: 'none', padding: 0, margin: 0, color: 'inherit', font: 'inherit', cursor: 'pointer' }}>Terms of Service</button></p>
        </div>
      </footer>
    </div>
  );
